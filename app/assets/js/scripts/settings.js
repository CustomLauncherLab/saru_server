    ...
    authKeys.forEach((val) => {
        ...
        const accHtml = `<div class="settingsAuthAccount" uuid="${acc.uuid}">
            <div class="settingsAuthAccountLeft">
                <img class="settingsAuthAccountImage" alt="${acc.displayName}" src="https://cravatar.eu/helmhead/${acc.uuid}">
            </div>
...
function populateReleaseNotes(){
    $.ajax({
        url: 'https://github.com/CustomLauncherLab/saru_server/releases.atom',
        success: (data) => {
